module.exports = {
  ...
  siteDescription:
    'Hemanth Yarlagadda is a DevOps Engineer, based in USA, who loves learn and try out new things.',
  siteKeywords:
    'devops, devops engineer, software engineer, cloud, AWS, GCP, Azure, CI/CD, Jenkins ',
